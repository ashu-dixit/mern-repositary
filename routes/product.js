...
route.post('/removefromcart', (req, res) => {
    users.findByIdAndUpdate(req.user._id, { "$pull": { "cart": { "_id": new mogoose.Types.ObjectId(req.body.productIdToRemove) } } }, { safe: true }, function (err, obj) {
    }).
        then((data) => res.send(req.body.productIdToRemove))
